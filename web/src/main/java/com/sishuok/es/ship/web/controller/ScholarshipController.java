 ...
 */
@Controller
@RequestMapping("/scholarship/sample")
public class ScholarshipController   extends BaseController<Ship, Long> {
    @Autowired
    ...
    public ScholarshipController() {
        ...
        //setResourceIdentity("scholarship:sample");
    }
    ...
    public String lista(@CurrentUser User user,
        ...
        searchable.addSearchFilter("type", SearchOperator.lte,3);
